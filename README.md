...
To download the setup file for the published version, [click here](https://aryehsilver.co.uk/my-content/The%20Shivisi%20App%20Setup%20File.zip) and change the file extension from .zip to .exe this is only due to browsers generally not allowing the download of .exe files.

Pull request are welcome. Any contribution to help this app is greatly appreciated.

I hope you find yourself having a better user experience when your reminded who is really running the show…
