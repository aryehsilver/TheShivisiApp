...
namespace TheShivisiApp.Models.Migrations
{
    ...
    [Migration("20231111223524_AddInitBearer")]
    partial class AddInitBearer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheShivisiApp.Models.Quote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("TheShivisiApp.Models.Settings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("UseRandomQuote")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BearerToken = "=@$11~AN-F@S$3~O-A0~Xk$-R=q~w$B-i~a$ol-M@q=_$Dt~g@k-$m2~WE-T6~b=@MZ$7-uF@~1$RA-@KT=$Yh@~h-~sq$qA~O=@-dD~Nu$Cl0~A-8~Oy$Zz~I-TN~GQ~R=@C~TN-2$H~cj~M-$ku~W=",
